...
# Based on the language used, hash-bang prvoides necessary setup/build/run/cleanup steps
# to run the script.
#
...
#
#   hash-bang:setup: mkdir -p {out_path}/log
#
# - After each run, we want to show if there is any error in the log.
#   And we want to cleanup the log files afterward.
#
#   hash-bang:cleanup: grep -ir error {out_path}/log
#   hash-bang:cleanup: rm -f {out_path}/log/*
